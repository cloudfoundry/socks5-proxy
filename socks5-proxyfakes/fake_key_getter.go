...
type FakeKeyGetter struct {
	GetStub        func(string, string, string) (ssh.PublicKey, error)
...
func (fake *FakeKeyGetter) Get(arg1 string, arg2 string, arg3 string) (ssh.PublicKey, error) {
	fake.getMutex.Lock()
...
func (fake *FakeKeyGetter) GetArgsForCall(i int) (string, string, string) {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
